...
func TestNewETOPMRequest(t *testing.T) {
	type args struct {
		webNo         string
		passCode      string
		receiverName  string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewETOPMRequest(tt.args.webNo, tt.args.passCode, tt.args.receiverName, tt.args.receiverID, tt.args.receiverTel, tt.args.receiverEmail, tt.args.orderNo, tt.args.ECPlatform, tt.args.totalPrice, tt.args.orderInfo, tt.args.note1, tt.args.note2, tt.args.payType, tt.args.atmRespost, tt.args.deadLine, tt.args.payEN, tt.args.codeType, tt.args.EPT); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewETOPMRequest() = %v, want %v", got, tt.want)
			}
		})
	}
}
